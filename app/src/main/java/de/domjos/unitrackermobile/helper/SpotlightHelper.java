...
public class SpotlightHelper {
    ...
    public SpotlightHelper(Activity activity) {
        this.targets = new ArrayList<>();
        this.activity = activity;
    }

    public void addTarget(View view, int title, int description, Runnable start, Runnable end) {
    ...
    public void addTarget(int x, int y, int height, int width, int title, int description, Runnable start, Runnable end) {
    ...
    public void addTargetToHamburger(Toolbar toolbar, int title, int description, Runnable start, Runnable end) {
        this.addTarget(this.getNavigationIconView(toolbar), title, description, start, end);
    }

    public void show() {
        this.spotlight = Spotlight.with(this.activity)
